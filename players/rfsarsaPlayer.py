""" 
    ...
    Description : Model free multi agent 
                  Reinforcement SARSA Linear Approximation
"""
    ...
    def SelectMove(self, moves, game_state):
        ...
        if self.TRAIN:
            ...
            if self.prevM is not None:
                nextmove = max_reward_search(game_state,self.id,moves)
                maxQ = self.getQvalue(game_state,nextmove)
